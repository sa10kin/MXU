export default {
  ...
  atlasBrowser: {
    title: 'Atlas Catalog',
    subtitle: 'Browse servants and craft essences, aliases, and battle presets',
    servants: 'Servants',
    ...
    imageDownloadFailed: 'Image download failed. Click to retry',
    noPresets: 'No party presets',
    presetHint: 'Presets are saved from the auto-battle party and battle plan editors.',
    presetSummary: '{{party}} slots · {{waves}} waves · {{turns}} turns',
    details: 'Details',
    selectPreset: 'Select a preset to inspect its battle plan.',
    deletePresetTitle: 'Delete party preset?',
    deletePresetMessage: 'Delete “{{name}}”? This cannot be undone.',
    party: 'Party slots',
    maxTurns: 'Maximum turns',
    wave: 'Wave {{index}}',
    turns: '{{count}} turns',
    turn: 'Turn {{index}}',
    partySlot: 'Slot {{slot}} · Servant {{servant}} · CE {{craftEssence}}',
    support: 'Support',
    actionTypes: {
      servantSkill: 'Servant skill',
  ...
  controller: {
    ...
    invalidAdbAddress: 'Invalid ADB address. Enter host:port',
