export default {
  ...
  atlasBrowser: {
    title: 'Atlas 図鑑',
    subtitle: 'サーヴァントと概念礼装を閲覧し、別名と編成プリセットを管理します',
    servants: 'サーヴァント図鑑',
    ...
    imageDownloadFailed: '画像の取得に失敗しました。クリックして再試行',
    noPresets: '編成プリセットはありません',
    presetHint: 'プリセットは自動戦闘の編成・戦闘手順画面から保存します。',
    presetSummary: '{{party}} 枠 · {{waves}} Wave · {{turns}} Turn',
    details: '詳細',
    selectPreset: 'プリセットを選択して戦闘手順を確認します。',
    deletePresetTitle: '編成プリセットを削除しますか？',
    deletePresetMessage: '「{{name}}」を削除します。この操作は元に戻せません。',
    party: '編成枠',
    maxTurns: '最大ターン数',
    wave: 'Wave {{index}}',
    turns: '{{count}} Turn',
    turn: 'Turn {{index}}',
    partySlot: '{{slot}} 枠 · サーヴァント {{servant}} · 概念礼装 {{craftEssence}}',
    support: 'サポート',
    actionTypes: {
      servantSkill: 'サーヴァントスキル',
      masterSkill: 'マスタースキル',
      orderChange: 'オーダーチェンジ',
      targetEnemy: '敵を選択',
      attack: '攻撃',
    },
  },
  ...
  controller: {
    ...
    invalidAdbAddress: 'ADB アドレスが無効です。ホスト:ポートを入力してください',
