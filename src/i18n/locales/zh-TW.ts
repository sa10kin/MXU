export default {
  ...
  atlas: {
    ...
    basicServantsHint:
      '下載從者名稱、基礎資訊、頭像、識別素材索引與概念禮裝索引；不下載戰鬥識別圖片或禮裝圖片。',
    status: '狀態',
    loading: '正在讀取快取',
    available: '已快取 {{count}} 名從者',
    notDownloaded: '未下載',
    cachePath: '快取位置',
    downloadBasicData: '下載基礎資料',
    refreshBasicData: '更新基礎資料',
    updating: '正在更新',
    ...
    downloadAllServantAssetsKinds:
      '素材依 faces、narrowfigure、commands、commandnp、status 分類儲存。',
    downloadAllServantAssetsConfirm: '開始完整下載',
  ...
  atlasBrowser: {
    title: 'Atlas 圖鑑',
    subtitle: '瀏覽從者與概念禮裝，維護別名和預設隊伍',
    servants: '從者圖鑑',
    craftEssences: '概念禮裝圖鑑',
    presets: '預設隊伍',
    searchServants: '搜尋名稱、圖鑑編號或別名',
    searchCraftEssences: '搜尋名稱、圖鑑編號、別名或 #Atlas編號',
    atlasIdDownloadHint: '輸入完整的 #Atlas編號（例如 #9408800）並按 Enter 下載禮裝圖片。',
    atlasIdDownloading: '正在下載指定 Atlas 禮裝……',
    atlasIdNotFound: 'Atlas 索引中不存在禮裝 #{{id}}。',
    atlasIdDownloadSuccess: '禮裝 #{{id}} 下載成功：新增 {{downloaded}}，已存在 {{skipped}}。',
    atlasIdDownloadFailed: '禮裝 #{{id}} 下載失敗：{{reason}}',
    allClasses: '全部職階',
    aliasPlaceholder: '別名，以英文逗號分隔',
    servantCatalogMissing: '找不到從者基礎資料，請先在設定 → Atlas 更新基礎資料。',
    craftEssenceCatalogMissing: '尚未載入目前伺服器的概念禮裝目錄。',
    noCachedCraftEssences: '尚未快取概念禮裝。可先搜尋名稱或圖鑑編號，再點擊預留圖快取。',
    noMatches: '沒有符合的圖鑑項目。',
    loadCraftEssences: '載入概念禮裝目錄',
    downloadImage: '下載此概念禮裝圖片',
    imageDownloadFailed: '圖片下載失敗，點擊重試',
    noPresets: '暫無預設隊伍',
    presetHint: '預設隊伍只能從自動戰鬥的隊伍與戰鬥編排中儲存。',
    presetSummary: '{{party}} 個位置 · {{waves}} Wave · {{turns}} Turn',
    details: '查看詳情',
    selectPreset: '選擇一個預設查看作戰明細。',
    deletePresetTitle: '刪除預設隊伍？',
    deletePresetMessage: '確定刪除「{{name}}」嗎？此操作無法復原。',
    party: '隊伍位置',
    maxTurns: '單場最大回合',
    wave: 'Wave {{index}}',
    turns: '{{count}} Turn',
    turn: 'Turn {{index}}',
    partySlot: '{{slot}} 號位 · 從者 {{servant}} · 禮裝 {{craftEssence}}',
    support: '助戰',
    actionTypes: {
      servantSkill: '從者技能',
      masterSkill: '御主技能',
  ...
  controller: {
    ...
    invalidAdbAddress: 'ADB 位址格式無效，請輸入主機:連接埠',
